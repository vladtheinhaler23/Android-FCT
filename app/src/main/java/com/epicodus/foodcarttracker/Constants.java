...
public class Constants {
    ...
    public static final String YELP_BASE_URL = "https://api.yelp.com/v2/search?term=food&category_filter=foodtrucks";
    public static final String YELP_LOCATION_QUERY_PARAMETER = "location";
    public static final String PREFERENCES_LOCATION_KEY = "location";
    public static final String FIREBASE_CHILD_SEARCHED_LOCATION = "searchedLocation";
    public static final String FIREBASE_CHILD_CARTS = "carts";
    public static final String FIREBASE_QUERY_INDEX = "index";
    public static final String EXTRA_KEY_POSITION = "position";
    public static final String EXTRA_KEY_CARTS = "carts";
